...
if(!isset($admin_styles)){
  // Paths to CSS files
  $css = array(
  	(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/DefaultRTL/css/' . Output::getClean($theme) . '.min.css',
  	...
  	(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/DefaultRTL/css/custom.css'
  );

  $js_sources = array(
  	(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/DefaultRTL/js/jquery.min.js',
  	(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/DefaultRTL/js/popper.min.js',
  	(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/DefaultRTL/js/bootstrap.min.js'
  );

  if($route == '/user/messaging'){
  	$js_sources[] = (defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/DefaultRTL/js/bootstrap3-typeahead.min.js';
  }
